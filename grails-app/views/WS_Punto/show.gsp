...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'WS_Punto.label', default: 'WS_Punto')}" />
        <g:set var="entitiesName" value="${message(code: 'WS_Punto.label', default: 'WS_Puntos')}" />
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#show-WS_Punto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-WS_Punto" class="content scaffold-show" role="main">
            <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
            </g:if>
            
            <f:display bean="WS_Punto" />
            
            %{--
            <f:with bean="WS_Punto">
				<ol class="property-list WS_Punto">
					
					<li class="fieldcontain">
                        <span id="nombre-label" class="property-label"><g:message code="WS_Punto.nombre.label" default="Nombre" /></span>
                        <div class="property-value" aria-labelledby="nombre-label"><f:display property="nombre"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="fecha_Registro-label" class="property-label"><g:message code="WS_Punto.dateCreated.label" default="Fecha de registro" /></span>
                        <div class="property-value" aria-labelledby="fecha_Registro-label"><f:display property="dateCreated"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="fecha_Cambio-label" class="property-label"><g:message code="WS_Punto.lastUpdated.label" default="Última actualización" /></span>
                        <div class="property-value" aria-labelledby="fecha_Cambio-label"><f:display property="lastUpdated"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="id_Autor-label" class="property-label"><g:message code="WS_Punto.id_Autor.label" default="Autor" /></span>
                        <div class="property-value" aria-labelledby="id_Autor-label"><f:display property="id_Autor"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="isDelete-label" class="property-label"><g:message code="WS_Punto.isDelete.label" default="isDelete" /></span>
            ...
            <g:form resource="${this.WS_Punto}" method="DELETE" name="delete_form">
				<fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.WS_Punto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

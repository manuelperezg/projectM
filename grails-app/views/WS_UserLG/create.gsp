...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#create-WS_UserLG" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-WS_UserLG" class="content scaffold-create" role="main">

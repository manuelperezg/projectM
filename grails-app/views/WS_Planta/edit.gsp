...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.WS_Planta}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
			  <li class="active"><g:message code="default.edit.label" args="[entityName]" /></li>
			</ul>	
		  </div>
		</div>
		<!-- .breadcrumb-box -->
        <a href="#edit-WS_Planta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-WS_Planta" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.WS_Planta}" method="PUT">
                <g:hiddenField name="version" value="${this.WS_Planta?.version}" />
                <fieldset class="form">
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.WS_Planta}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:form>
        </div>
    </body>

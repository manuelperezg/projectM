...
<html>
    ...
    <body>
        ...
        <div id="show-horario" class="content scaffold-show" role="main">
            ...
            <f:with bean="horario">
				<ol class="property-list horario">
					...
					<li class="fieldcontain">
                        <span id="matricula-label" class="property-label"><g:message code="horario.matricula.label" default="Matrícula" /></span>
                        <div class="property-value" aria-labelledby="matricula-label"><f:display property="matricula"/></div>
                    </li>

                    <li class="fieldcontain">
                        <span id="fecha_Inicio-label" class="property-label"><g:message code="horario.fecha_Inicio.label" default="Fecha y hora de inicio" /></span>
                        <div class="property-value" aria-labelledby="fecha_Inicio-label"><f:display property="fecha_Inicio"/></div>
                    </li>

                    <li class="fieldcontain">
                        <span id="fecha_Final-label" class="property-label"><g:message code="horario.fecha_Final.label" default="Fecha y hora de final" /></span>
                        <div class="property-value" aria-labelledby="fecha_Final-label"><f:display property="fecha_Final"/></div>
                    </li>
                    <!--
                    <li class="fieldcontain">
                        <span id="fecha_Registro-label" class="property-label"><g:message code="horario.dateCreated.label" default="Fecha de registro" /></span>
                        <div class="property-value" aria-labelledby="fecha_Registro-label"><f:display property="dateCreated"/></div>
                    </li>
                    <li class="fieldcontain">
                        <span id="fecha_Cambio-label" class="property-label"><g:message code="horario.lastUpdated.label" default="Última actualización" /></span>
                        <div class="property-value" aria-labelledby="fecha_Cambio-label"><f:display property="lastUpdated"/></div>
                    </li>
                    <li class="fieldcontain">
                        <span id="id_Autor-label" class="property-label"><g:message code="horario.id_Autor.label" default="Autor" /></span>
            ...
            <g:form resource="${this.horario}" method="DELETE" name="delete_form">
                <fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.horario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-material" class="content scaffold-show" role="main">
            ...
            <f:with bean="material">
				<ol class="property-list material">
					...
					<li class="fieldcontain">
                        <span id="archivo_Foto-label" class="property-label"><g:message code="material.archivo_Foto.label" default="Foto de referencia" /></span>
                        <div class="property-value" aria-labelledby="archivo_Foto-label">
							<g:if test="${material.archivo_Foto}">
					...
					<li class="fieldcontain">
                        <span id="nombre-label" class="property-label"><g:message code="material.nombre.label" default="Nombre" /></span>
                        <div class="property-value" aria-labelledby="nombre-label"><f:display property="nombre"/></div>
                    </li>
                    <li class="fieldcontain">
                        <span id="categoria-label" class="property-label"><g:message code="material.categoria.label" default="Categoría" /></span>
                        <div class="property-value" aria-labelledby="categoria-label"><f:display property="categoria"/></div>
                    </li>
                    
                    <!--
                    <li class="fieldcontain">
                        <span id="fecha_Registro-label" class="property-label"><g:message code="material.dateCreated.label" default="Fecha de registro" /></span>
                        <div class="property-value" aria-labelledby="fecha_Registro-label"><f:display property="dateCreated"/></div>
                    </li>
                    <li class="fieldcontain">
                        <span id="fecha_Cambio-label" class="property-label"><g:message code="material.lastUpdated.label" default="Última actualización" /></span>
                        <div class="property-value" aria-labelledby="fecha_Cambio-label"><f:display property="lastUpdated"/></div>
                    </li>
                    <li class="fieldcontain">
                        <span id="id_Autor-label" class="property-label"><g:message code="material.id_Autor.label" default="Autor" /></span>
            ...
            <g:form resource="${this.material}" method="DELETE" name="delete_form">
				<fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.material}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

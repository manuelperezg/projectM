...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.material}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
        ...
        <div id="edit-material" class="content scaffold-edit" role="main">
            ...
            <g:uploadForm resource="${this.material}" action="upchange" method="POST">
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.material}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:uploadForm>
        </div>
    </body>

...
<html>
			...
			function jconfirm(pregunta,mensaje,id){
                swal({
                    ...
                    buttonsStyling: true
                     ...
                     location.href = "/sesion/remove/"+id;
                });
            }
        </script>
    </head>
    <body>
					...
					<div class="input-group">
						<div class="input-group-btn search-panel">
							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
								<span id="search_concept">${session.getAttribute('sesion_search_rows')} Registros</span> <span class="caret"></span>
							</button>
						...
						<input type="hidden" name="search_rows" id="search_rows" value="${session.getAttribute('sesion_search_rows')}">
						<input type="hidden" name="search_clean" id="search_clean" value="0">
						<input type="text" class="form-control" name="search_word" id="search_word" placeholder="Palabra a buscar..." value="${session.getAttribute('sesion_search_word')}">
        ...
        <div id="list-sesion" class="content scaffold-list" role="main">
            ...
            <f:table collection="${sesionList}" />
			
			%{--
			<table>
                <thead>
                    <tr>
						<g:sortableColumn property="nombre" title="${message(code: 'sesion.nombre.label', default: 'Name')}" />
                ...
                <tbody>
                    <g:each in="${sesionList}" var="item" status="i">
            ...
            <div class="pagination">
                <g:paginate total="${sesionCount ?: 0}" />
            </div>
        </div>
    </body>
</html>

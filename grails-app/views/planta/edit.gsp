...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#edit-planta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-userLG" class="content scaffold-edit" role="main">
            ...
            <g:uploadForm resource="${this.planta}" action="upchange" method="POST">
                <g:hiddenField name="version" value="${this.planta?.version}" />
                <fieldset class="form">
                    %{--
                    <f:all bean="planta"/>
                    --}%
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.planta}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:uploadForm>
        </div>
    </body>

...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li class="active"><g:message code="default.report.label" args="['Listado de plantas']" /></li>
			</ul>	
		  </div>
		</div>
		<!-- .breadcrumb-box -->
        ...
        <div id="upload-data" class="content scaffold-create" role="main">
            <iframe frameborder="0" width="100%" height="450px" src="http://unilever-mes.com/jasperserver/flow.html?_flowId=viewReportFlow&j_username=jasperadmin&j_password=jasperadmin&standAlone=true&decorate=no&_flowId=viewReportFlow&ParentFolderUri=%2Freports&reportUnit=%2Freports%2Flistado_plantas"></iframe>
        </div>
    </body>
</html>

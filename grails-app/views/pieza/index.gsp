			...
			function jconfirm(pregunta,mensaje,id){
                swal({
                    ...
                    buttonsStyling: true
                     ...
                     location.href = "${request.contextPath}/pieza/remove/"+id;
                });
            }
        </script>
    </head>
    <body>
					...
					<div class="input-group">
						<div class="input-group-btn search-panel">
							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
								<span id="search_concept">${session.getAttribute('pieza_search_rows')} Registros</span> <span class="caret"></span>
							</button>
						...
						<input type="hidden" name="search_rows" id="search_rows" value="${session.getAttribute('pieza_search_rows')}">
						<input type="hidden" name="search_clean" id="search_clean" value="0">
						<input type="text" class="form-control" name="search_word" id="search_word" placeholder="Palabra a buscar..." value="${session.getAttribute('pieza_search_word')}">
        ...
        <div id="list-pieza" class="content scaffold-list" role="main">
			...
			<table>
                <thead>
                    <tr>
						<g:sortableColumn property="nombre" title="${message(code: 'pieza.nombre.label', default: 'Name')}" />
                ...
                <tbody>
                    <g:each in="${piezaList}" var="item" status="i">

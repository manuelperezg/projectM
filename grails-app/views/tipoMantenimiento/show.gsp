...
<html>
    ...
    <body>
        ...
        <div id="show-tipoMantenimiento" class="content scaffold-show" role="main">
            ...
            %{--
            <f:display bean="tipoMantenimiento" />
            --}%
            
            <f:with bean="tipoMantenimiento">
				<ol class="property-list tipoMantenimiento">
					
					<li class="fieldcontain">
                        <span id="archivo_Foto-label" class="property-label"><g:message code="tipoMantenimiento.archivo_Foto.label" default="Foto de referencia" /></span>
                        <div class="property-value" aria-labelledby="archivo_Foto-label">
							<g:if test="${tipoMantenimiento.archivo_Foto}">
					...
					<li class="fieldcontain">
                        <span id="nombre-label" class="property-label"><g:message code="tipoMantenimiento.nombre.label" default="Nombre" /></span>
                        <div class="property-value" aria-labelledby="nombre-label"><f:display property="nombre"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="descripcion-label" class="property-label"><g:message code="tipoMantenimiento.descripcion.label" default="Descripción" /></span>
                    ...
                    <li class="fieldcontain">
                        <span id="id_Autor-label" class="property-label"><g:message code="tipoMantenimiento.id_Autor.label" default="Autor" /></span>
            ...
            <g:form resource="${this.tipoMantenimiento}" method="DELETE" name="delete_form">
				<fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.tipoMantenimiento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

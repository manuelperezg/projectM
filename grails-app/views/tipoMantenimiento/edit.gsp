...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.tipoMantenimiento}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
        ...
        <div id="edit-tipoMantenimiento" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.tipoMantenimiento}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.tipoMantenimiento}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:uploadForm resource="${this.tipoMantenimiento}" action="upchange" method="POST">
                <g:hiddenField name="version" value="${this.tipoMantenimiento?.version}" />
                <fieldset class="form">
                    %{--
                    <f:all bean="tipoMantenimiento"/>
                    --}%
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.tipoMantenimiento}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:uploadForm>
        </div>
    </body>

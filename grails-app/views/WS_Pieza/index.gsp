...
<html>
			...
			function jconfirm(pregunta,mensaje,id){
                swal({
                    ...
                    buttonsStyling: true
                     ...
                     location.href = "/WS_Pieza/remove/"+id;
                });
            }
        </script>
    </head>
    <body>
		...
		<!-- .breadcrumb-box -->
		<a href="#list-WS_Pieza" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
					...
					<div class="input-group">
						<div class="input-group-btn search-panel">
							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
								<span id="search_concept">${session.getAttribute('WS_Pieza_search_rows')} Registros</span> <span class="caret"></span>
							</button>
						...
						<input type="hidden" name="search_rows" id="search_rows" value="${session.getAttribute('WS_Pieza_search_rows')}">
						<input type="hidden" name="search_clean" id="search_clean" value="0">
						<input type="text" class="form-control" name="search_word" id="search_word" placeholder="Palabra a buscar..." value="${session.getAttribute('WS_Pieza_search_word')}">
        ...
        <div id="list-WS_Pieza" class="content scaffold-list" role="main">
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>
            
            <f:table collection="${WS_PiezaList}" />
			
			%{--
			<table>
                <thead>
                    <tr>
						<g:sortableColumn property="nombre" title="${message(code: 'WS_Pieza.nombre.label', default: 'Name')}" />
                ...
                <tbody>
                    <g:each in="${WS_PiezaList}" var="item" status="i">
            ...
            <div class="pagination">
                <g:paginate total="${WS_PiezaCount ?: 0}" />
            </div>
        </div>
    </body>
</html>

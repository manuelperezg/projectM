...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#create-tipoVerificacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-tipoVerificacion" class="content scaffold-create" role="main">

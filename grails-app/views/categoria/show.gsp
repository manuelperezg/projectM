...
<html>
    <head>
        ...
        <g:set var="entitiesName" value="${message(code: 'categoria.label', default: 'Categorías de materiales')}" />
        ...
        <div id="show-categoria" class="content scaffold-show" role="main">
            ...
            <f:with bean="categoria">
				<ol class="property-list categoria">
                    ...
                    <li class="fieldcontain">
                        <span id="descripcion-label" class="property-label"><g:message code="categoria.descripcion.label" default="Descripción" /></span>
                        <div class="property-value" aria-labelledby="descripcion-label"><f:display property="descripcion"/></div>
                    </li>

                    %{--
                    <li class="fieldcontain">
                        <span id="fecha_Registro-label" class="property-label"><g:message code="categoria.dateCreated.label" default="Fecha de registro" /></span>
                        <div class="property-value" aria-labelledby="fecha_Registro-label"><f:display property="dateCreated"/></div>
                    </li>

                    <li class="fieldcontain">
                        <span id="fecha_Cambio-label" class="property-label"><g:message code="categoria.lastUpdated.label" default="Última actualización" /></span>

...
<html>
    ...
    <body>
        ...
        <div id="show-subsistema" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.subsistema}" action="deleting" method="POST" name="delete_form">
				<fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="editing" resource="${this.subsistema}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

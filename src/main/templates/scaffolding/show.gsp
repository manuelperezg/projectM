        ...
        <div id="show-${propertyName}" class="content scaffold-show" role="main">
            ...
            <f:with bean="${propertyName}">
				<ol class="property-list ${propertyName}">
                    ...
                    <li class="fieldcontain">
                        <span id="fecha_Registro-label" class="property-label"><g:message code="${propertyName}.dateCreated.label" default="Fecha de registro" /></span>
                        <div class="property-value" aria-labelledby="fecha_Registro-label"><f:display property="dateCreated"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="fecha_Cambio-label" class="property-label"><g:message code="${propertyName}.lastUpdated.label" default="Última actualización" /></span>
                        <div class="property-value" aria-labelledby="fecha_Cambio-label"><f:display property="lastUpdated"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="id_Autor-label" class="property-label"><g:message code="${propertyName}.id_Autor.label" default="Autor" /></span>
                        <div class="property-value" aria-labelledby="id_Autor-label"><f:display property="id_Autor"/></div>
                    </li>
                    
                    <li class="fieldcontain">
                        <span id="isDelete-label" class="property-label"><g:message code="${propertyName}.isDelete.label" default="isDelete" /></span>

...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.subsistema}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
        ...
        <div id="edit-subsistema" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.subsistema}" method="PUT">
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.subsistema}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:form>
        </div>
    </body>

            ...
            <f:with bean="subsistema">
				<ol class="property-list subsistema">
					...
					<li class="fieldcontain">
                        ...
                        <div class="property-value" aria-labelledby="maquina-label"><f:display property="maquina"/></br><f:display property="maquina.linea.planta"/>&nbsp;-&nbsp;<f:display property="maquina.linea"/></div>
                    </li>
                    ...
                    <li class="fieldcontain">
                        <span id="isDelete-label" class="property-label"><g:message code="subsistema.isDelete.label" default="isDelete" /></span>

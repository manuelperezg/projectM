...
<html>
    ...
    <body>
        ...
        <div id="show-alumnos" class="content scaffold-show" role="main">
            <h1><g:message code="default.report.label" args="['Listado general de alumnos recursantes']" /></h1>
        </div>
        <div id="upload-data" class="content scaffold-create" role="main">
            <iframe frameborder="0" width="100%" height="450px" src="http://${session.getAttribute('servidor')}:9090/jasperserver/flow.html?_flowId=viewReportFlow&j_username=jasperadmin&j_password=jasperadmin&standAlone=true&decorate=no&_flowId=viewReportFlow&ParentFolderUri=%2Freports&reportUnit=%2Freports%2Frecursantes"></iframe>
        </div>
    </body>
</html>

...
<html>
    ...
    <body>
        ...
        <div id="list-alumnos" class="content scaffold-list" role="main">
            ...
            <!--
            <f:table collection="${alumnosList}" />
            -->
            <table>
                <thead>
                    <tr>
						<g:sortableColumn property="documento" title="Comprobante" />
                        ...
                        <g:sortableColumn property="planest" title="Planes de estudio" />
                        <g:sortableColumn property="generacion" title="Generación" />
                    </tr>
                </thead>

                <tbody>
                    <g:each in="${alumnosList}" var="alumno" status="i">
                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                            <td>
									<a href="${createLink(uri: 'acuse')}?username=${alumno.matricula}"><g:img uri="${request.contextPath}/assets/skin/print.gif" title="Comprobante de registro" width="14px" height="14px"/></a>
                            </td>
            ...
            <div class="pagination">
                <g:paginate total="${alumnosCount ?: 0}" />
            </div>
        </div>
    </body>
</html>

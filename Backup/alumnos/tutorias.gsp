...
<html>
    <head>
        ...
        <title>Seleccione tutorias</title>
            ...
            function jconfirm(pregunta,mensaje){
                ...
                if (free == 0 && total_disponibles == 0){
                    swal({
                        ...
                        text: '${message(code: "default.register-no-choice.ask.message", args: ["tutorías"], default: "Ya no tiene tutorías disponibles a registrar para continuar")}',
                        type: 'warning',
                    ...
                    swal({
                        ...
                        text: '${message(code: "default.register-empty.ask.message", args: ["tutoría"], default: "Se requiere de seleccionar por lo menos una tutoría para continuar")}',
                        type: 'warning',
                        showCancelButton: false,
                        confirmButtonColor: '#5CB85C',
                        confirmButtonText: 'Aceptar',
    ...
    <body>
        ...
        <div id="list-alumnos" class="content scaffold-list" role="main">
            <h1><g:message code="default.register.label" args="['tutorías']" />&nbsp;-&nbsp;<g:textField name="free" id="free" value="${session.getAttribute("materias_libres").toInteger()}" style="width:35px;" readonly="readonly"/>&nbsp;Disponibles</h1>
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>
            <g:form method="POST" action="confirmarTutorias" name="confirm_form">
				<table>
					<thead>
						<tr>
						...
						<g:each in="${gruposList}" var="grupo" status="i">
							<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
								...
								<td>
									...
									<g:if test="${grupo.isInscritoTutoria(session.getAttribute("username"), grupo.id) == 0}">
                ...
                <fieldset class="buttons">
                    <input class="save" type="button" value="${message(code: 'default.button.register.label', default: 'Registrar')}" onclick="jconfirm('${message(code: 'default.register.ask.message', default: 'Registrar su selección')}','${message(code: 'default.register.info.message', args:['Tutorias'], default: 'Ha indicado que desea registrar su selecci\u00f3n de Grupos+Tutorias, de continuar no podr\u00e1 cambiar la informaci\u00f3n.')}');" />
                </fieldset>
            </g:form>

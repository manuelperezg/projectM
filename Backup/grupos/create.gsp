...
<html>
    ...
    <body>
        ...
        <a href="#create-grupos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-grupos" class="content scaffold-create" role="main">
                ...
                <fieldset class="form">
                    ...
                    <f:with bean="grupos">
                        ...
                        <f:field property="materia_id">
                            <g:select name="materia_id" from="${materias}" optionKey="id" optionValue="nombre"/>
                        </f:field>

                        <f:field property="docente_id">
                            <g:select name="docente_id" from="${docentes}" optionKey="id" optionValue="nombre"/>
                        </f:field>
